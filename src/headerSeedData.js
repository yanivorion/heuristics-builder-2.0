export const HEADER_SEED_DATA = [
  ...
  { rule_id: 4, category: "Header Grid", when: "Super Grid Cell", "in": "Any Parent", "if": "Cell contains Menu / Cart / Search / Login → Language LTR", action: "Set Alignment", parameters: "Position: Most right side", summary: "Set Alignment | Position: Most right side", priority: 1, status: "Mapped", note: "" },
  ...
  { rule_id: 6, category: "Header Grid", when: "Super Grid Cell", "in": "Any Parent", "if": "Cell contains Menu / Cart / Login → Language LTR → Header padding = 0px", action: "Set Margin", parameters: "Margin Right: 24px", summary: "Set Margin | Margin Right: 24px", priority: 1, status: "Mapped", note: "" },
